...
window.onload = function init() {
  ...
  p = perspective(45.0, 2.0, 5, 20);
  
  //p = ortho(-10,10,-10,10,0,50);
...
function render() 
{
	...
	//mv = mult(mv, translate(-4.5,-4.5,-15));	
	...
	mv = mult(mv, translate(0.5,1.5,0));
	mv = mult(mv, rotateZ(-60));
	mv = mult(mv, translate(-0.5,1,0));
	matStack.push(mv);
	mv = mult(mv, scale(1, 2, 1));
	...
	mv = mult(mv, translate(0.5,1.0,0));
