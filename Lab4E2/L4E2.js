...
function render()
{
    ...
    gl.uniform4fv(light[0].position, mult(transpose(mv), vec4(0.0, -1.0, 0.0, 0.0)));
    gl.uniform4fv(light[1].position, mult(transpose(mv), vec4(0.0, 1.0, 0.0, 1.0)));
    ...
    //draw cube
    var cubeTF = mult(mv, mult(rotateX(rx),rotateY(ry)));
